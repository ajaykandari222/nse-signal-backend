...
WATCHLIST = list(dict.fromkeys([
    ...
    "SANOFI","SEQUENT","CAPLIPOINT","SOLARA","MANKIND","LAURUSLABS","GLAND",
    # DEFENCE & AEROSPACE
    "BEML","GRSE","COCHINSHIP","MAZDOCK","GARDENREACH","MIDHANI","MTARTECH",
    ...
    "FIEMIND","GABRIEL","JAMNAAUTO","LUMAX","UNOMINDA","SUBROS","CEATLTD","TVSMOTOR","MUNJALAU","FMGOETZE",
    ...
    # OIL & GAS
    "HINDPETRO","MRPL","CASTROLIND","GUJRATGAS","MGL","IGL","ATGL",
    # LOGISTICS
...
SECTOR_STOCKS = {
    ...
    "Defence & Aerospace":     ["HAL","BEL","BHEL","BEML","GRSE","COCHINSHIP","MAZDOCK","GARDENREACH"],
    ...
    try:
        ...
        with _jobs_lock:
            ...
            if not all_results:
                ...
                _jobs["lt_scan"]["result"]["message"] = "Scan finished but Yahoo Finance returned no fundamentals for any stock (likely rate-limiting). Wait a few minutes and press Refresh."
